...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        widget = new QWidget(Name_lst_1);
        widget->setObjectName("widget");
        widget->setGeometry(QRect(10, 30, 232, 262));
        ...
        Button1_1 = new QPushButton(widget);
        ...
        layoutWidget = new QWidget(Name_lst_2);
        ...
        Button_2_1 = new QPushButton(layoutWidget);
        ...
        layoutWidget1 = new QWidget(Name_lst_3);
        ...
        Button_3_1 = new QPushButton(layoutWidget1);
        ...
        layoutWidget2->setGeometry(QRect(40, 10, 231, 31));
        ...
        label_0 = new QLabel(layoutWidget2);
